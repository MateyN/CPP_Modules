...
/*   Updated: 2023/02/27 01:27:40 by mnikolov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << GREEN << "Default ClapTrap constructor is called." << RESET << std::endl;
    this->Name = "";
    this->Hit = 10;
    this->Energy = 10;
    this->attackDamage = 0;
...
{
    std::cout << GREEN << this->Name << "ClapTrap constructor is called." << RESET << std::endl;
    this->Name = str;
    this->Hit = 10;
    this->Energy = 10;
    this->attackDamage = 0;
...
{
    std::cout << GREEN << "ClapTrap copy constructor is called" << RESET << std::endl;
    *this = obj;
}
...
void    ClapTrap:: takeDamage(unsigned int amount)
{
	...
	std::cout << this->Name << " was attacked and lost " << amount << " hit points, he now has " << this->Hit << " hit points." << std::endl;
}

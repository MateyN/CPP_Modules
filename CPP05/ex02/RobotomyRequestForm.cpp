...
/*   Updated: 2023/01/17 12:15:26 by mnikolov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "RobotomyRequestForm.hpp"

RobotomyRequestForm:: RobotomyRequestForm(void) : _target("Unknown"), _signed(false), _gradeToSign(72), _gradeToExec(45)
{
...
void    RobotomyRequestForm:: execute(Bureaucrat const & executor) const
{
    ...
    if (_signed == 1 && executor.getGrade() <= _gradeToExec)
    {
        ...
        if (rand() % 10 + 1) /* generate random number between 1 and 10 */
